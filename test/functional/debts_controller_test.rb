...
class DebtsControllerTest < ActionController::TestCase
  ...
  test "should create debt" do
    assert_difference('Debt.count') do
      post :create, debt: { amount: @debt.amount, deadline: @debt.deadline, from: @debt.from, to: @debt.to }
    end
  ...
  test "should update debt" do
    put :update, id: @debt, debt: { amount: @debt.amount, deadline: @debt.deadline, from: @debt.from, to: @debt.to }
    assert_redirected_to debt_path(assigns(:debt))
  end
